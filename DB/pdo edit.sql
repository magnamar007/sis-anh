...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-10-2022 a las 16:23:24
...
CREATE TABLE `cliente` (
  ...
  `ci` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `cliente` (`id_cliente`, `ci`, `nombre`, `apellido`, `direccion`) VALUES
(1, '78908768', 'rodrigo', 'sulca acosta', 'barrio centenario avenida 25 de septiembre'),
(2, '7512099', 'miguel angel', 'moya torres', 'avenida mara final esquina 31 de marzo');
...
(2, 'miguel angel', 'moya torres', 'miguel', '$2y$10$m7fdc8amBOuuzLOk3fFi6ODxMzjX1xfXNhZTaSysbueYrdONIYLv6', 'miguel@gmail.com');
